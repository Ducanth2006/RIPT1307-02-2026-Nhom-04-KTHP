...
export default function AIChatbot() {
  ...
  const processUserMessage = (text: string) => {
    ...
    setTimeout(() => {
      ...
      // Hỗ trợ nhập mét như 1m75 hoặc 1.75m
      if (!detectedHeight) {
      ...
      // Quét số chung chung nếu người dùng ghi "nặng 65" hoặc "cao 170"
      if (!detectedWeight) {
      ...
      // 1a. Xử lý click nút "Tính Size: Cao & Nặng"
      ...
      // 1b. Tư vấn size dựa trên chiều cao & cân nặng cụ thể
      ...
      // 2. Tư vấn chọn size chung chung
      ...
      // 8. Hỏi về giày thể thao
      else if (cleanedText.includes("giày") || cleanedText.includes("sneaker") || cleanedText.includes("shoes")) {
        replyText = `**BỘ SƯU TẬP GIÀY THỂ THAO SPORTSTRIDE**\n\nChúng tôi cung cấp các dòng giày chạy bộ (running), giày tập gym, và giày thời trang với công nghệ đế đệm EVA êm ái, bám đường cực tốt và lưới thoáng khí chống bí chân.\n\nBạn muốn tìm giày để tập luyện hay để đi chơi hằng ngày?`;
        links = [
          { label: "Xem tất cả Giày", url: "/products?category=giay" }
        ];
        suggestions = ["👟 Giày chạy bộ chuyên nghiệp", "👟 Giày thời trang dạo phố"];
      }

      // 9. Chào hỏi thông thường
